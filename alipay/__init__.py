...
# 支付宝封装(不需要做任何修改)
from seven.settings import BASE_DIR
...
alipay = AliPay(
    ...
    app_notify_url="http://47.112.195.186/appnotifyurl/",   # 异步支付通知url
    ...
    return_url="http://47.112.195.186/returnurl/",   # 同步支付通知url,在这个页面可以展示给用户看，只有付款成功后才会跳转
)